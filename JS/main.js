...
function initApplication() {
    ...
    // Обновляем кнопки авторизации в хедере
    updateAuthButtons();
    
    // Чат-бот (остается без изменений)
    initChatBot();
...
function updateAuthButtons() {
    ...
    if (currentUser) {
        ...
        // Добавляем кнопку профиля в навигацию
        updateNavigation();
    }
}
...
function updateNavigation() {
    ...
    if (navLinks && !navLinks.querySelector('.profile-link')) {
